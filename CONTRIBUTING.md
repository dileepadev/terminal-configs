# Contributing to terminal-configs

Thank you for your interest in contributing to [terminal-configs](https://github.com/dileepadev/terminal-configs)! We welcome contributions, including bug fixes, feature enhancements, documentation improvements, and other general improvements.
...
1. **Fork the repository**  
   ...
   To fork the repository, click the **Fork** button in the top right corner of this page or click [here to fork the repository](https://github.com/dileepadev/terminal-configs/fork).
...
- Refer to the following templates and guidelines before submitting your changes:
  - [terminal-configs/](./) - Root directory of the repository.
    ...
    - [PULL_REQUEST_GUIDELINES.md](PULL_REQUEST_GUIDELINES.md) - Guidelines for pull request submissions.
